	...
	<div id="sidebar-collapse" class="col-md-3 col-sm-3 col-lg-2 sidebar">
		<div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i class="fas fa-home"></i>Trang chủ</a>
                        </h4>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                       <a href="category.html"><i class="fas fa-eye"></i>Xem</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href=""><i class="fas fa-plus"></i>Thêm</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour"><i class="fas fa-user"></i>Người dùng</a>
                        </h4>
                    </div>
