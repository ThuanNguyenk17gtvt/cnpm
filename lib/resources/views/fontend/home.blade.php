        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-2 ">
                    <a href="{{asset('home')}}"><p><i class="fas fa-home" style="margin-right: 10px;"></i>TTN-SHOP</p></a>
                </div>
                                    ...
                                    <li class="dropdown pull-right">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> 
                                             @if( isset($user))
                                                {{$user->name }}
                                                @else
                                                <i class="fas fa-user">Người dùng</i>
                                            @endif
                                           {{--  {{Auth::user()->name}} --}}
                                         {{--   Người dùng --}}
                                            <span class="caret"></span></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <a href="{{asset('registration')}}" class="navbar-link " id="dk" ><i class="fas fa-user"></i>Đăng ký</a>
                                             <a href="{{asset('login')}}" class="navbar-link"><i class="fas fa-user">Đăng nhập</i></a>
                                            <li><a href="{{asset('logout')}}"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-md-3">
                    <nav id="menu">
                        <ul>
                            ...
                            <li class="menu-item"><i style="" class="fas fa-mobile-alt "></i><a href="#" title="">iPhone</a></li>
                            <li class="menu-item"><i class="fas fa-mobile-alt"></i><a href="#" title="">Samsung</a></li>
                            <li class="menu-item"><i class=" fas fa-mobile-alt"></i><a href="#" title="">Sony</a></li>
                            <li class="menu-item"><i class="fas fa-mobile-alt "></i><a href="#" title="">HTC</a></li>
                            <li class="menu-item"><i class=" fas fa-mobile-alt"></i><a href="#" title="">LG</a></li>
                            <li class="menu-item"><i class=" fas fa-mobile-alt"></i><a href="#" title="">OPPO</a></li>
                            <li class="menu-item"><i class=" fas fa-mobile-alt"></i><a href="#" title="">Blackberry</a></li>                      
                        </ul>
